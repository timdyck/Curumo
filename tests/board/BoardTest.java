...
public class BoardTest {
    ...
    public void InitialBoard() {
        ...
        String[][] boardArray = BoardUtils.boardToArray(board);
    ...
    public void ArrayToBoard() {
        ...
        Board newBoard = BoardUtils.arrayToBoard(boardMatrix);
    ...
    public void InitialBoardMovementConstants() {
        ...
        String[][] blackBoardArray = BoardUtils.bitBoardToArray(movement.blackPieces, blackPiece);
        for (int i = 0; i < Board.DIMENSION; i++) {
        ...
        String[][] whiteBoardArray = BoardUtils.bitBoardToArray(movement.whitePieces, whitePiece);
        for (int i = 0; i < Board.DIMENSION; i++) {
        ...
        String[][] emptyBoardArray = BoardUtils.bitBoardToArray(movement.empty, emptyPiece);
        for (int i = 0; i < Board.DIMENSION; i++) {
