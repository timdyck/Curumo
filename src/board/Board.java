...
public class Board {
    ...
    public static Board StandardBoard() {
        ...
        bitBoards.put(PieceType.WP, BoardUtilities.WP_INITIAL);
        bitBoards.put(PieceType.WR, BoardUtilities.WR_INITIAL);
        bitBoards.put(PieceType.WN, BoardUtilities.WN_INITIAL);
        bitBoards.put(PieceType.WB, BoardUtilities.WB_INITIAL);
        bitBoards.put(PieceType.WQ, BoardUtilities.WQ_INITIAL);
        bitBoards.put(PieceType.WK, BoardUtilities.WK_INITIAL);
        bitBoards.put(PieceType.BP, BoardUtilities.BP_INITIAL);
        bitBoards.put(PieceType.BR, BoardUtilities.BR_INITIAL);
        bitBoards.put(PieceType.BN, BoardUtilities.BN_INITIAL);
        bitBoards.put(PieceType.BB, BoardUtilities.BB_INITIAL);
        bitBoards.put(PieceType.BQ, BoardUtilities.BQ_INITIAL);
        bitBoards.put(PieceType.BK, BoardUtilities.BK_INITIAL);
    ...
    public void updateBoard(Move move) {
        ...
        case PROMOTION:
            ...
            break;
        case TYPICAL:
            updateAfterTypicalMove(move, fromBitBoard, toBitBoard);
            break;
        default:
            break;
        }
    ...
    private void updateAfterTypicalMove(Move move, long fromBitBoard, long toBitBoard) {
